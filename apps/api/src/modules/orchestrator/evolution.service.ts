...
export class EvolutionService {
  ...
  spawn(spec: SpawnAgentSpec): SpawnResult {
    ...
    return {
      ...
      notices: [
        'دستیار جدید هنوز هیچ مجوزی ندارد؛ برای فعال شدن، از بخش مجوزها برای آن مجوز صادر کنید.',
        'این دستیار تا راه‌اندازی دوبارهٔ سرور فعال می‌ماند و پس از آن باید دوباره ساخته شود.',
        'خروجی این دستیار نیز مانند سایر دستیاران پیش از استفاده به بازبینی وکیل نیاز دارد.',
      ],
    };
  }
