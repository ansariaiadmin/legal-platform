# راهنمای کامل Legal Platform — سیستم حقوقی برای وکلای ایرانی — برای افراد غیر فنی

**نسخه:** v1.0.5 — نصب خودکار + آپدیت خودکار
...
- **تکنولوژی:** NestJS + Next.js + Postgres pgvector
- **آدرس پیش‌فرض:** http://localhost:8080
- **نوع:** web
...
http://localhost:8080
```
- ورود: ادمین پس از نصب ساخته می‌شود / npm run db:seed
- سلامت: http://localhost:8080/api/health یا http://localhost:3001/api/health
...
- **v1.0.4 (Strict Final 10/10 True):** نسخه غیرفنی + نصب خودکار + آپدیت خودکار (همین نسخه)
...
- ایشو باز کن: https://github.com/ansariaiadmin/legal-platform/issues

**برای افراد کاملا غیر فنی:** فقط `install.sh` را اجرا کن، بعد مرورگر را باز کن به http://localhost:8080 — همین!
