# 🧙‍♂️ جادوگر نصب Legal Platform — دفتر وکالت هوشمند — فوق ساده — پشتیبانی صفر — Zero Support
...
## 🎯 Legal Platform — دفتر وکالت هوشمند چیه؟ به زبان ساده:

دفتر شلوغ، کاغذ گم، منشی هوشمند — پرونده‌ها timeline، موکل‌ها CRM، مالی Zarinpal، AI 6 وکیل متخصص + RAG، اسناد PDF→OCR→RAG، E-Signature + S3 + PWA رو موبایل نصب تو دادگاه
...
### 🤖 AI Provider — 6 وکیل متخصص

**چیه؟** 6 وکیل AI: مدنی، کیفری، خانواده، ثبتی، بین‌الملل، عمومی
...
### 📱 SMS Panel — برای نوبت‌دهی موکل

**چیه؟** وقتی نوبت موکل می‌شه پیامک می‌ره: "نفر بعدی تویی — بیا تو تماس"
...
**چیه؟** درگاه پرداخت ایرانی — موکل وقت می‌خره

**گزینه‌ها:**
- **zarinpal** — https://next.zarinpal.com/ → Merchant ID
- **mock** — تست بدون پول



## 🔔 سیستم ناتیفیکیشن — برای نوبت + پرداخت + موکل — سقف 10/10

**کانال‌ها:**
1. **In-App** — همیشه روشن — تو داشبورد وکیل
2. **SMS** — نوبت موکل — مهم — "نفر بعدی تویی"
3. **Email** — فاکتور، اطلاع
4. **Telegram** — برای وکیل — موکل جدید یا پرداخت — تلگرام خبر می‌ده

**ربات تلگرام:** @BotFather → /newbot → توکن → chat_id

**کد:** `apps/api/src/modules/notifications/notification.service.ts` — سقف
...
**پشتیبانی صفر:** همه راهنماها همون‌جا بود — اگر بازم گیر کردی: https://github.com/ansariaiadmin/legal-platform/issues
