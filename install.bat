@echo off
echo ========================================
echo   Legal Platform — سیستم حقوقی برای وکلای ایرانی - Auto Installer
echo   پلتفرم حقوقی خودمیزبان برای وکلای ایرانی
echo ========================================
echo.
...
echo Login: ادمین پس از نصب ساخته می‌شود / npm run db:seed
echo ========================================
