...
echo.
echo ========================================
echo   legal-platform — Setup Wizard v3.1.0 — پشتیبانی صفر — تاریکی روشن شد — Windows
echo ========================================
echo.
echo سلام! 👋 جادوگر legal-platform — v3.1.0 — تاریکی روشن شد
echo.
...
:create_env
(
echo # legal-platform — .env — v3.1.0 — تاریکی روشن شد — %date% %time%
...
echo.
echo 🎉 جادو تمام! legal-platform آماده — تاریکی روشن شد! 🎉
